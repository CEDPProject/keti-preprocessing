...
class RefineFrequency():
    ...
    def make_static_frequencyData(self, data, freq):
        ...
        Returns:
            DataFrame: New DataFrame with resampled static frequency
        ...
        # 숫자로 변환 가능한 값만 유지하고 나머지는 NaN으로 변환
        data_static_frequency = data_static_frequency.apply(pd.to_numeric, errors='coerce')
